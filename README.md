...
*   - 🎮 **[PixelCraft Studio Mobile Games Testing Portfolio](PixelCraft-Studio-Games-Testing):** This folder contains my real test artifacts, including comprehensive manual checklists, test cases, and structural bug reports (**27 documented bug reports for Shadows of Silence** and **7 documented bug reports for Last Signal 2**).
