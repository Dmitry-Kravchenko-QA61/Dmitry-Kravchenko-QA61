...
*   - 🎮 **[PixelCraft Studio Mobile Games Testing Portfolio](PixelCraft-Studio-Games-Testing):** This folder contains my real test artifacts, including comprehensive manual checklists, test cases, and well-structured bug reports (**27 bug reports for Shadows of Silence** and **7 bug reports for Last Signal 2**).
