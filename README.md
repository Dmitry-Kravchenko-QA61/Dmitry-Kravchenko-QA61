...
Welcome to my QA Portfolio! I am a detail-oriented Junior Quality Assurance Engineer with a solid foundation in manual web and mobile application testing. Backed by a strong technical background in systems administration and networking, I bring a meticulous approach to defect troubleshooting, environment configuration, and cross-platform software quality assurance.
...
Target: Verify build stability, UI controls, interruptions, and performance limits for mobile titles.
...
* **Core Artifacts:** Functional checklists, mobile-specific boundary test cases, interruption testing matrix, and device logs.
